package com.bingli.MoliAPI.generate;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        // 指定生成参数
        String packageName = "com.bingli.MoliAPI";
        String dataName = "应用管理";
        String dataKey = "appInfo";
        String upperDataKey = "AppInfo";
        ...
        // 这里补上 moli-api-backend
        String projectPath = System.getProperty("user.dir") + File.separator + "moli-api-backend";
